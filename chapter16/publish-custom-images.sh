...
function publish_custom_images() {
    ...
    docker build -t manning-airflow/airflow-executors:k8s -f Dockerfile.executors_default_image .
    docker build -t manning-airflow/airflow-executors-deps:k8s -f Dockerfile.executors_extended_image .
    echo "==============================================="
    ...
    docker tag manning-airflow/airflow-executors-deps:k8s localhost:3632/manning-airflow/airflow-executors-deps:k8s
    echo "==============================================="
    ...
    docker push localhost:3632/manning-airflow/airflow-executors-deps:k8s
}
