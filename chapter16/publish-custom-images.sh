...
function publish_custom_images() {
    ...
    docker build -t manning-airflow/airflow-executors-tf:k8s -f Dockerfile.executors_tensorflow .
    docker build -t manning-airflow/airflow-executors-tf-old:k8s -f Dockerfile.executors_tensorflow_old .
    echo "==============================================="
